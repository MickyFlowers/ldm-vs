...
camera = RealSenseCamera(exposure_time=700, serail_number=l515_serial_number)
...
left_arm_pose[:3, 3] = np.array([4.87310613e-02, 6.88952506e-01, 3.46895660e-01])
left_arm_pose[:3, :3] =[[-0.74075829, -0.46993225,  0.48004254],
                        [-0.67172623,  0.52646557 ,-0.52116971],
                        [-0.00781142, -0.70851795 ,-0.70564956]]
...
for i in range(1):
    ...
    while count < 5000:
        ...
        right_robot.moveToWorldPose(right_tcp_pose, vel=1.0, acc=1.0, asynchronous=False)
        time.sleep(0.2)
        ...
        # 确保保存目录存在
        save_dir_image = "/mnt/workspace/cyxovo/dataset/2025-08-18-charge-single/img"
