...
camera = RealSenseCamera(exposure_time=600, serail_number=l515_serial_number)
...
left_arm_pose[:3, 3] = np.array([-1.93094871e-02, 5.15340185e-01, 4.32000554e-01])
...
for i in range(000, 100):
    ...
    while count < 20:
        ...
        # # 确保保存目录存在
        # save_dir = "/mnt/workspace/cyxovo/dataset/finetune_data/img"
