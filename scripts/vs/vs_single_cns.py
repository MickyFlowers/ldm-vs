...
camera = RealSenseCamera(exposure_time=500,serail_number='f1421776')
ip = "172.16.8.33"
ur_robot = UR(ip)
# activate gripper
...
while True:
    ...
    while True:
        ...
        if use_roma:
            ...
            vel = controller_dif.get_control_rate(color_image)
            match_img = np.concatenate([tar_bgr, color_image], axis=1)
        else:
