...
camera = RealSenseCamera(exposure_time=700,serail_number='f1421776')
ip = "172.16.10.33"
ur_robot = UR(ip)
# activate gripper
...
config = OmegaConf.load(
    "logs/2025-08-26T01-38-46_dino_ddpm_charge/configs/2025-08-26T01-38-46-project.yaml"
)
...
model.load_state_dict(
    torch.load(
        "logs/2025-08-26T01-38-46_dino_ddpm_charge/checkpoints/epoch=000373.ckpt"
    )["state_dict"],
    strict=True,
)
